...
while cap.isOpened():
    if not paused:
        ...
        results = model.track(frame, persist=True, classes=[0], conf=0.15)
    ...
    if paused:
        ...
        cv2.putText(annotated, "[LOW CONF] Press Space to pause and select players", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.65, (255, 255, 255), 2)
    else:
